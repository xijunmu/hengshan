...
-- 初始化 用户-角色-权限 数据
insert into user values(1, 'admin', '1E95272D3B47AB50BC5108C9A7200AB1','https://img2.woyaogexing.com/2023/12/04/252170494265e17853195349efbf99a9.jpg','12345678@qq.com', '15888888888', '1','1', sysdate(), null);
insert into user values(2, 'test', '1E95272D3B47AB50BC5108C9A7200AB1', 'https://img2.woyaogexing.com/2022/11/07/81617bf06d5295a0!400x400.jpg','12345678@qq.com', '15666666666', '0', '1',sysdate(), null);
...
insert into article values(2,"测试文章2","测试文章2内容","测试文章2摘要",2,"https://img0.baidu.com/it/u=3120410141,1466872751&fm=253&fmt=auto&app=138&f=JPEG?w=801&h=500",100,10,1,1,1,0,1,1,sysdate(),sysdate());
